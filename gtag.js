    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_instanceDestinationId": "G-V4WZGN7VET",
                "tag_id": 3
            }, {
...
*/
    ...
    var za = function (a) {
        ...
        a = a || [];
        for (var b in a)
            a.hasOwnProperty(b) && (va(b) ? this.h[Number(b)] = a[Number(b)] : this.B.set(b, a[b]))
    };
    ba = za.prototype;
    ...
    ba.set = function (a, b) {
        if (!this.C)
            if ("length" === a) {
                ...
                va(a) ? this.h[Number(a)] = b : this.B.set(a, b)
    }
        ;
    ba.get = function (a) {
    ...
    ba.length = function () {
        ...
        ;
    ba.Ub = function () {
        for (var a = xa(this.B, 1), b = 0; b < this.h.length; b++)
            a.push(b + "");
        return new za(a)
    }
        ;
    ...
    Ca.prototype.set = function (a, b) {
        this.B.Pf() || (!this.B.has(a) && this.C && this.C.has(a) ? this.C.set(a, b) : this.B.set(a, b))
    }
        ;
    ...
    gb.prototype.h = function (a, b) {
        return this.qb.apply(new hb(this, a), Array.prototype.slice.call(arguments, 1))
    }
        ;
...
*/
 ...
 jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    ...
    var $c = {
        ...
        , fd = function (a, b, c) {
            ...
            if (a instanceof gb || a instanceof kb) {
                ...
                if ("toString" === b)
                    return a instanceof gb ? a.T : a.toString();
                if ("hasOwnProperty" === b)
    ...
    var Le = [], Me = [], Ne = [], Oe = [], Pe = [], Qe = {}, Re, Se, Ue = function () {
        ...
        var e = Qe[c], f = b && 2 === b.type && d.Mj && e && -1 !== Ye.indexOf(c), g = {}, h = {}, l;
        for (l in a)
            a.hasOwnProperty(l) && 0 === l.indexOf("vtp_") && (e && d && d.vj && d.vj(a[l]),
                e && (g[l] = a[l]),
    ...
    var nf = {
        Pk: function (a, b) {
            b[oe.gi] && "string" === typeof a && (a = 1 == b[oe.gi] ? a.toLowerCase() : a.toUpperCase());
    ...
    If.prototype.D = function (a) {
        var b = 20 > this.events.length && 16384 > a.K + this.C
            , c = this.Sa === a.C && this.h === a.B && this.B === a.D;
    ...
    var Fg = function () {
        ...
        var a = new kb;
        a.set("containerId", 'G-V4WZGN7VET');
        a.set("version", '1');
    ...
    var O = {
        ...
        , xh = Object.freeze((wh[O.g.Z] = 1,
            ...
            wh[O.g.oe] = 1,
            wh));
    Object.freeze([O.g.fa, O.g.Ga, O.g.zb, O.g.za, O.g.pf, O.g.Ba, O.g.ff, O.g.Ci]);
    var yh = {}
        , zh = Object.freeze((yh[O.g.ri] = 1,
            yh[O.g.si] = 1,
            yh[O.g.ui] = 1,
            yh[O.g.vi] = 1,
            yh[O.g.wi] = 1,
    ...
    Kh.ne = Number("0") || 0;
    Kh.ja = "dataLayer";
    Kh.bk = "ChEI8MG+pQYQqYzlpY6YxIv5ARIlAEEnTghnqH3jGXMBZLEm8KALUGZUti+UK8dQnDG9WCAPJ7e6YhoCabk\x3d";
    var Nh = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    var Pi = []
        ...
        , Ui = function (a) {
            Qi ? 0 <= a && a < Pi.length && Pi[a] && (Pi[a].disconnect(),
                Pi[a] = void 0) : z.clearInterval(a)
        };
    var Vi = /:[0-9]+$/
    ...
    var fj = function (a, b, c) {
        ...
        , hj = function (a) {
            var b = !!a.Xb + "." + !!a.Yb;
            a && a.zc && a.zc.length && (b += "." + a.zc.join("."));
        ...
        , rj = function () {
            ...
            for (var c = b.querySelectorAll("*"), d = 0; d < c.length && 1E4 > d; d++) {
                ...
                if (!(0 <= oj.indexOf(e.tagName.toUpperCase())) && e.children instanceof HTMLCollection) {
                    ...
                    (!f || T(58) && -1 !== qj.indexOf(e.tagName)) && a.push(e)
                }
            }
            return {
                elements: a,
    ...
    var Pj = function (a) {
        ...
        , Qj = function (a) {
            return a.tagName + ":" + a.isVisible + ":" + a.R.length + ":" + uj.test(a.R)
        };
                ...
                if ("auto_detect" === a.mode || Uc(a.auto_detect)) {
                    ...
                    if (c) {
                        var d = Pj({
                            Xb: !1,
                            Yb: !1,
                            zc: c.exclude_element_selectors,
                            Ra: {
                                email: !!c.email,
                                phone: !!c.phone,
                                address: !!c.address
    ...
    ; var Hk = [O.g.H, O.g.P, O.g.Jb, O.g.xd]
        ...
        , Ok = function (a) {
            for (var b = a[O.g.Ua], c = Array.isArray(b) ? b : [b], d = {
                ...
                ++d.Gc)
                a.hasOwnProperty(O.g.fg) && m(Jk, function (e) {
                    return function (f) {
                    ...
                    m(a, function (e) {
                        return function (f, g) {
                            f !== O.g.Ua && f !== O.g.fg && vk(ik, f, g, c[e.Gc], ui(), vi())
                        }
                    }(d))
        }
        , Pk = function () {
    ...
    var bl = function () {
        ...
        , jl = function () {
            ...
            if (a) {
                var b = Wk();
                if (b.siloed) {
                    for (var c = [], d = rf.Rf ? rf.Rf.split("|") : [rf.ctid], e = cl(), f = {}, g = 0; g < b.siloed.length; f = {
                        nd: f.nd
                    },
                        g++)
                        f.nd = b.siloed[g],
                            !$k && Ka(f.nd.isDestination ? e : d, function (h) {
                                return function (l) {
                                    return l === h.nd.ctid
                                }
                            }(f)) ? $k = !0 : c.push(f.nd);
    ...
    var ll = function () {
        for (var a = Wk(), b = bl(), c = 0; c < b.length; c++) {
            ...
            d ? (d.state = 2,
                d.containers = bl(),
                d.destinations = dl()) : a.container[b[c]] = {
                    state: 2,
                    containers: bl(),
                    destinations: dl()
                }
        ...
        for (var e = dl(), f = 0; f < e.length; f++) {
            ...
            g ? (g.state = 2,
                g.containers = bl(),
                g.destinations = dl()) : a.destination[e[f]] = {
                    state: 2,
                    containers: bl(),
                    destinations: dl()
                }
    ...
    ; var Ol = function (a, b, c, d, e, f, g, h, l, n, p, q) {
        ...
        , dm = function (a) {
            return new Ol(a.Wg, a.wk, a.D, a.je, a.h, a.K, a.B, a.ie, a.C, a.zd, a.qb, a.T)
        };
    var em = [O.g.H, O.g.P]
    ...
    var qm = function (a) {
        if (T(53)) {
            for (var b = "1", c = 0; c < fm.length; c++) {
                var d = b, e, f = fm[c], g = hk[f];
                e = void 0 === g ? 0 : om.hasOwnProperty(g) ? 12 | om[g] : 8;
                var h = kk();
                h.accessedAny = !0;
                var l = h.entries[f] || {};
                e = e << 2 | pm(l.implicit);
                b = d + ("" + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[e] + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[pm(l.declare) << 4 | pm(l.default) << 2 | pm(l.update)])
            }
            void 0 !== a && (b += km(a));
            return b
        }
    ...
    var Nm = function (a) {
        ...
        , Pm = function (a, b) {
            return Tm.test(window.document.location.hostname) || "/" === b && Sm.test(a)
        }
        , ym = function () {
    ...
    var bn = {
        ...
        , cn = function (a) {
            ...
            var g = c.Rm, h = 4 + d + (g ? "" + gg(2, 1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[g] : ""), l, n = c.hm;
            ...
            if (t && a) {
                ...
                if ("GTM" !== v && "OPT" !== v)
                    ...
                    var w = u[1];
                    r = "" + gg(5, 3) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[1 + w.length] + (c.Jl || 0) + w
                }
            } else
                r = "";
            return h + l + p + r
    ...
    var kn = function (a, b, c, d) {
        ...
        , nn = /[?&]($|#)/
        , on = function (a, b, c) {
            for (var d, e = a.search(ln), f = 0, g, h = []; 0 <= (g = kn(a, f, b, e));)
    ...
    var tn = function () {
        ...
        return a ? a[a.length - 1] == z.location.origin ? 1 : 2 : pn(z.top) ? 1 : 2
    }
        , sn = function (a, b) {
    ...
    var wn = function (a) {
        ...
        , vn = function (a, b) {
            ...
            if (c.fetch) {
                ...
                un(c, a, void 0 === b ? !1 : b, void 0 === d ? !1 : d)
        };
    var xn = function () { };
    var yn = function (a) {
    ...
    var Cn = function (a, b, c) {
        ...
        if (0 === h)
            if (a.purpose && a.vendor) {
                ...
                l = n && "1" === b && a.purposeOneTreatment && "CH" === a.publisherCC ? !0 : n && Bn(a.purpose.consents, b)
            } else
                l = !0;
        else
            l = 1 === h ? a.purpose && a.vendor ? Bn(a.purpose.legitimateInterests, b) && Bn(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
        return l
    }
        , Bn = function (a, b) {
            return !(!a || !a[b])
        ...
        , Fn = function (a) {
            ...
            return "error" === a.cmpStatus || 0 !== a.internalErrorState ? a.internalBlockOnErrors ? (wn({
                            ...
                            for (h in Gn)
                                if (Gn.hasOwnProperty(h))
                                    if ("1" === h) {
                                        var l, n = c, p = !0;
                                        p = void 0 === p ? !1 : p;
                                        l = Fn(n) ? !1 === n.gdprApplies || "tcunavailable" === n.tcString || void 0 === n.gdprApplies && !p || "string" !== typeof n.tcString || !n.tcString.length ? !0 : Cn(n, "1", 0) : !1;
                                        g["1"] = l
                                    } else
                                        g[h] = Cn(c, h, Gn[h]);
                            d = g
    ...
    function Ln() {
        var a = {}
            , b = (a.ad_storage = "denied",
                a.wait_for_update = Hn,
                a);
        Lk(b)
    }
    function Jn(a) {
        return "function" === typeof z.__tcfapi || "function" === typeof a.B.__tcfapi || null != Dn(a) ? !0 : !1
    }
    var Kn = function () {
    ...
    function Nn(a) {
        var b = {}
            , c = (b.ad_storage = a.Sf["1"] ? "granted" : "denied",
                b);
        Mk(c, {
            eventId: 0
        }, {
    ...
    Wb();
    !Sb("Safari") || Wb() || (Tb() ? 0 : Sb("Coast")) || Ub() || (Tb() ? 0 : Sb("Edge")) || (Tb() ? Rb("Microsoft Edge") : Sb("Edg/")) || (Tb() ? Rb("Opera") : Sb("OPR")) || Vb() || Sb("Silk") || Sb("Android") || hn();
    var Vn = {}
        , Wn = null
        , Xn = function (a) {
            for (var b = [], c = 0, d = 0; d < a.length; d++) {
            ...
            for (var r = Vn[f], t = Array(Math.floor(b.length / 3)), u = r[64] || "", v = 0, w = 0; v < b.length - 2; v += 3) {
                var x = b[v]
                    , y = b[v + 1]
                    , A = b[v + 2]
                    , B = r[x >> 2]
    ...
    ; var eo, fo = function () {
        ...
        a && (b.h[O.g.Yd] = a.architecture,
            b.h[O.g.Zd] = a.bitness,
            a.fullVersionList && (b.h[O.g.ae] = a.fullVersionList.map(function (c) {
                return encodeURIComponent(c.brand || "") + ";" + encodeURIComponent(c.version || "")
            }).join("|")),
            b.h[O.g.be] = a.mobile ? "1" : "0",
            b.h[O.g.ce] = a.model,
            b.h[O.g.de] = a.platform,
            b.h[O.g.ee] = a.platformVersion,
            b.h[O.g.fe] = a.wow64 ? "1" : "0")
    };
    function jo(a, b, c, d) {
    ...
    function wo(a, b) {
        var c = [hc.userAgent, (new Date).getTimezoneOffset(), hc.userLanguage || hc.language, Math.floor(Va() / 60 / 1E3) - (void 0 === b ? 0 : b), a].join("*"), d;
        if (!(d = ko)) {
    ...
    var Io = function (a, b, c, d) {
        ...
        , Ko = function () {
            ...
            var h = a.replace(to, ""), l = e.replace(to, ""), n;
            if (!(n = h === l)) {
                var p = "." + l;
    ...
    function Vo(a, b) {
        var c = b.split(".");
        5 === c.length ? (No[a] = c.slice(0, 2).join("."),
            Oo[a] = {
                id: c.slice(2, 4).join("."),
                Eh: Number(c[4]) || 0
            }) : 3 === c.length ? Oo[a] = {
    ...
    ; var ap = /^\w+$/
        ...
        , ep = function (a, b) {
            yk("ad_storage") ? dp() ? a() : Ek(a, "ad_storage") : b ? xb("TAGGING", 3) : Dk(function () {
                ep(a, !0)
            }, ["ad_storage"])
        }
        , gp = function (a) {
    ...
    var rp = function (a, b) {
            ...
            for (var d = kp(b.prefix), e = 0; e < a.length; ++e) {
                ...
                if (void 0 !== cp[f]) {
                    var g = pp(f, d)
                        , h = c[g];
                    if (h) {
                        var l = Math.min(qp(h), Va()), n;
                        b: {
                            var p = l;
                            if (wm(z))
                                for (var q = zm(g, G.cookie, void 0, "ad_storage"), r = 0; r < q.length; ++r)
                                    if (qp(q[r]) > p) {
                                        n = !0;
                                        break b
                                    }
        ...
        , qp = function (a) {
            return 0 !== sp(a.split(".")).length ? 1E3 * (Number(a.split(".")[1]) || 0) : 0
        };
    function hp(a) {
        var b = sp(a.split("."));
    ...
    function sp(a) {
        return 3 > a.length || "GCL" !== a[0] && "1" !== a[0] || !/^\d+$/.test(a[1]) || !bp.test(a[2]) ? [] : a
    }
            ...
            if (wm(z)) {
                ...
                ep(function () {
                    m(d, function (f, g) {
                        ...
                        if (h.length) {
                            var l = h[0], n = qp(l), p = 0 !== sp(l.split(".")).length ? l.split(".").slice(3) : [], q = {}, r;
    ...
    ; var $p = function (a) {
        var b = Zp[a.target.ba];
        if (!a.isAborted && b)
            for (var c = Yp(a), d = 0; d < b.length; ++d) {
                try {
                    b[d](c)
                } catch (e) {
                    a.isAborted = !0
    ...
    ; var zq = !1;
    function Aq() {
        if (yq("join-ad-interest-group") && Ga(hc.joinAdInterestGroup))
            return !0;
        zq || (rn(''),
            zq = !0);
    ...
    var ws = function (a, b, c) {
        ...
        if (b) {
            ...
            if (!e)
                return !1;
            var g = Xn(decodeURIComponent(f.replace(/\+/g, " ")) + ":" + decodeURIComponent(e.replace(/\+/g, " ")));
            if (!vs(g, b))
                return !1
        }
        d && 4 != d && (a = on(a, "rfmt", d));
    ...
    ; var bt = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/)
        , ct = {
            cl: ["ecl"],
        ...
        , et = "google customPixels customScripts html nonGooglePixels nonGoogleScripts nonGoogleIframes".split(" ")
        , ht = function (a) {
            var b = ki("gtm.allowlist") || ki("gtm.whitelist");
            b && N(9);
            $k ? b = "e c cid gct rep ogt_cons_disc ccd_ads_first ccd_ads_last ccd_fl_first ccd_fl_last ccd_ga_first ccd_ga_last ccd_mc_first ccd_mc_last".split(" ") : Rh && (b = ["google", "gtagfl", "lcl", "zone"]);
            ft() && (Rh ? N(116) : N(117),
                gt && (b = [],
            ...
            return function (g) {
                ...
                var x = !n || u;
                x || !(0 <= l.indexOf("sandboxedScripts")) || c && -1 !== c.indexOf("sandboxedScripts") || (x = Oa(e, et));
                return f[h] = x
            }
        }
        , gt = !1;
    ...
    ; var nt = {
        ...
        , ot = {}
        , pt = Object.freeze((ot[O.g.Pa] = !0,
            ot))
        , qt = 0 <= G.location.search.indexOf("?gtm_diagnostics=") || 0 <= G.location.search.indexOf("&gtm_diagnostics=")
        , st = function (a, b, c) {
            if (zl && "config" === a && !(1 < Hp(b).J.length)) {
                ...
                for (h in d) {
                    var l = rt(d[h], f);
                    l.length && (qt && console.log(l),
                        g.push(h))
                }
                g.length && (g.length && zl && lt.push(b + "*" + g.join(".")),
    ...
    Ct.prototype.addListener = function (a, b, c) {
        var d = ++this.D;
        this.h[a] = this.h[a] || {};
        this.h[a][String(d)] = {
            listener: b,
    ...
    function eu(a) {
        var b = a.eventId, c = a.Fb, d = cu[b] || {}, e = [], f;
        for (f in d)
    ...
    var uv = function (a) {
        ...
        var e, f = !1, g = gv(b);
        if (T(71))
            for (var h = at(), l = 0; g && l < h.length; l++)
                g = (0,
                    h[l])(d, b);
        if (g)
            e = fv(b);
    ...
    function sv(a) {
        for (var b = [], c = 0; c < a.length; c++)
            if (a[c]) {
                ...
                if (Nh[d] || void 0 !== Oe[c][oe.Fk] || di[d] || Et(d, 2))
                    b[c] = !0
            }
        return b
    }
    ...
    Hv.prototype.push = function (a, b, c, d) {
        void 0 !== c && (1 === Cv(this, c).status && (Cv(this, c).status = 2,
            this.push("require", [{}], c, {})),
    ...
    Hv.prototype.flush = function (a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length;) {
            ...
            if (f.messageContext.deferrable)
                !g || Cv(this, g).C ? (f.messageContext.deferrable = !1,
    ...
    var Kx = function (a, b, c) {
        ...
        return {
            createEvent: function (g, h, l) {
                var n = a()
                    , p = n.ph
                    , q = void 0 !== l ? Math.round(l) : void 0 !== h ? Math.round(n.ph * h) : Math.round(n.yj)
                    , r = void 0 !== h ? Math.round(100 * h) : 0 >= p ? 0 : Math.round(q / p * 100)
                    , t = G.hidden ? !1 : .5 <= Oi(c);
                d();
                var u = void 0;
                void 0 !== b && (u = [b]);
                var v = mx(c, "gtm.video", u);
    ...
    function Oz(a, b) {
        ...
        var d = Wc(b) || {}
            , e = Wc(a, this.h, 1).Mf()
            , f = e.m;
        d.omitEventContext && (f = dm(new Tl(e.m.eventId, e.m.priorityId)));
        var g = new Wp(e.target, e.eventName, f);
        d.omitHitData || I(e.h, g.h);
    ...
    var AA = function (a, b) {
        ...
        , CA = function () {
            var a = 0
                , b = function (c) {
                    var d = c.target;
                    if (d && 3 !== c.which && !(c.xh || c.timeStamp && c.timeStamp === a)) {
                        a = c.timeStamp;
                        d = yc(d, ["a", "area"], 100);
                        if (!d)
                            return c.returnValue;
                        var e = c.defaultPrevented || !1 === c.returnValue, f = qx("aelc", e ? "nv.mwt" : "mwt", 0), g;
                        g = e ? qx("aelc", "nv.ids", []) : qx("aelc", "ids", []);
    ...
    var GA = function (a) {
            ...
            var c = 0
                ...
                , e = function () {
                    d ? c = z.setTimeout(e, a) : (c = 0,
                        IA(),
                        qx("sdl", "init", !1) && !JA() && (uc(z, "scroll", f),
                            uc(z, "resize", f),
                            ox("sdl", "init", !1)));
                    d = !1
                }
        ...
        , IA = function () {
            var a = EA()
                , b = a.nh
                , c = a.oh
                , d = b / FA.scrollWidth * 100
                , e = c / FA.scrollHeight * 100;
            LA(b, "horiz.pix", "PIXELS", "horizontal");
            LA(d, "horiz.pct", "PERCENT", "horizontal");
            LA(c, "vert.pix", "PIXELS", "vertical");
            LA(e, "vert.pct", "PERCENT", "vertical");
            ox("sdl", "pending", !1)
        }
        , LA = function (a, b, c, d) {
            var e = GA(b), f = {}, g;
        ...
        , MA = function () {
            ...
            return function () {
                var c = Ni()
                    , d = c.height;
                a = Math.max(FA.scrollLeft + c.width, a);
                b = Math.max(FA.scrollTop + d, b);
                return {
                    nh: a,
                    oh: b
                }
        ...
        , JA = function () {
            return !!(Object.keys(GA("horiz.pix")).length || Object.keys(GA("horiz.pct")).length || Object.keys(GA("vert.pix")).length || Object.keys(GA("vert.pct")).length)
        };
    function OA(a, b) {
        var c = this;
        L(E(this), ["options:!DustMap", "triggerId:?*"], arguments);
        ...
        switch (d.horizontalThresholdUnits) {
            case "PIXELS":
                HA(d.horizontalThresholds, b, "horiz.pix");
                break;
            case "PERCENT":
                HA(d.horizontalThresholds, b, "horiz.pct")
        }
        switch (d.verticalThresholdUnits) {
            case "PIXELS":
                HA(d.verticalThresholds, b, "vert.pix");
                break;
            case "PERCENT":
                HA(d.verticalThresholds, b, "vert.pct")
        }
        qx("sdl", "init", !1) ? qx("sdl", "pending", !1) || H(function () {
            return IA()
        }) : (ox("sdl", "init", !0),
            ox("sdl", "pending", !0),
            H(function () {
    ...
    var dc = da(["data-gtm-yt-inspected-"]), PA = ["www.youtube.com", "www.youtube-nocookie.com"], QA, RA = !1;
    var SA = function (a, b, c) {
        ...
        , VA = function (a, b) {
            ...
            function f(F) {
                switch (F) {
                    case 1:
                        ...
                        y = a.getPlaybackRate();
                        b.kh ? Cw(t.createEvent("start")) : t.gd();
                        u = SA(b.Qh, b.Ph, a.getDuration());
                        return g(F);
                    default:
                        return f
                }
            ...
            function h(F) {
                ...
                switch (F) {
                    ...
                    case 3:
                        ...
                        a.getCurrentTime() && (b.jh ? Cw(t.createEvent(J)) : t.gd());
                        q();
                        return l;
                    case -1:
                        return e(F);
            ...
            function n() {
                ...
                b.ih && Cw(t.createEvent("complete", 1));
                return e(-1)
            }
            function p() { }
            function q() {
            ...
            function r() {
                if (u.length && 0 !== y) {
                    ...
                    c = function () {
                        d = 0;
                        c = p;
                        0 < u.length && u[0].Ca === J.Ca && (u.shift(),
                            Cw(t.createEvent("progress", J.He, J.Le)));
                        r()
                    }
                        ;
        ...
        , WA = function (a, b) {
            if (!a.getAttribute("data-gtm-yt-inspected-" + b.nb) && (cc(a, "data-gtm-yt-inspected-" + b.nb),
                YA(a, b.xe))) {
                a.id || (a.id = ZA());
                var c = z.YT
                    , d = c.get(a.id);
                ...
                for (g in e)
                    f.wd = g,
                        e.hasOwnProperty(f.wd) && d.addEventListener(f.wd, function (h) {
                            return function (l) {
                                return e[h.wd](l.data)
                            }
                        }(f)),
                        f = {
                            wd: f.wd
        ...
        , YA = function (a, b) {
            ...
            if ($A(c, "embed/")) {
                ...
                if (b) {
                    var d;
                    var e = -1 !== c.indexOf("?") ? "&" : "?";
                    -1 < c.indexOf("origin=") ? d = c + e + "enablejsapi=1" : (QA || (QA = G.location.protocol + "//" + G.location.hostname,
                        G.location.port && (QA += ":" + G.location.port)),
                        d = c + e + "enablejsapi=1&origin=" + encodeURIComponent(QA));
                    var f;
                    f = Gb(d);
                    a.src = Eb(f).toString();
                    return !0
        ...
        , $A = function (a, b) {
            ...
            for (var c = 0; c < PA.length; c++)
                if (0 <= a.indexOf("//" + PA[c] + "/" + b))
                    return !0;
            return !1
        }
        , ZA = function () {
            var a = Math.round(1E9 * Math.random()) + "";
            return G.getElementById(a) ? ZA() : a
        };
    function aB(a, b) {
        var c = this;
        L(E(this), ["dustOptions:!DustMap", "triggerId:?*"], arguments);
        ...
        var d = !!a.get("captureStart")
            ...
            , g = UA(Wc(a.get("progressThresholdsPercent")))
            , h = TA(Wc(a.get("progressThresholdsTimeInSeconds")))
        ...
        H(function () {
            for (var t = G.getElementsByTagName("script"), u = t.length, v = 0; v < u; v++) {
                ...
                if ($A(w, "iframe_api") || $A(w, "player_api"))
                    return b
            }
    ...
    var eB = function (a) {
        ...
        if (k(c)) {
            ...
            if (Ga(URL))
                try {
                    var e = new URL(c);
                    return e.pathname + gB(d ? e.search : "")
                } catch (h) {
                    return
                }
            var f = bj(c);
        ...
        , gB = function (a) {
            ...
            for (var d = 0; d < b.length; d++) {
                var e = b[d]
                    , f = e.indexOf("=");
                hB[0 <= f ? e.substring(0, f) : e] || c.push(b[d])
            }
    ...
    var kD = function (a) {
        ...
        , lD = function (a) {
            if (a.metadata.is_merchant_center || !Us(a.m))
                return !1;
            if (!U(a.m, O.g.qf)) {
                var b = U(a.m, O.g.Nd);
                return !0 === b || "true" === b
        ...
        , nD = function (a, b) {
            var c = Xp(a, O.g.Ld, a.m.C[O.g.Ld]);
            if (c && void 0 !== c[b || a.eventName])
                return c[b || a.eventName]
        }
        , oD = function (a, b, c) {
            a.h[O.g.oe] || (a.h[O.g.oe] = {});
            a.h[O.g.oe][b] = c
        };
    var pD = !1
        , qD = function (a) {
            var b = a.eventName === O.g.ic && zk() && lD(a)
            ...
            return !(!hc.sendBeacon || d || h || e || f || g || b || !c && pD)
        };
    var rD = function (a) {
        var b = 0
            , c = 0;
    ...
    ba.xk = function (a) {
        ...
        if (!this.h) {
            ...
            lD(a) && -1 === (hc.userAgent || "").indexOf("Firefox") && -1 === (hc.userAgent || "").indexOf("FxiOS") && c(z, "beforeunload", function () {
                pD = !0
            });
            this.Sh();
            this.B = 0
    ...
    var xD = function (a, b, c) {
        ...
        , AD = function (a, b) {
            ...
            var d = b.metadata.cookie_options
                , e = d.prefix + "_ga"
                , f = jo(d, void 0, void 0, O.g.P);
            if (!1 === U(b.m, O.g.eb) && yD(b) === a)
                c = !0;
            else {
                var g = Zm(a, zD[0], d.domain, d.path);
                c = 1 !== Rm(e, g, f)
            }
            return c
        }
        , yD = function (a) {
            var b = a.metadata.cookie_options
                , c = b.prefix + "_ga"
                , d = Ym(c, b.domain, b.path, zD, O.g.P);
            if (!d) {
                var e = String(U(a.m, O.g.kc, ""));
                e && e != c && (d = Ym(e, b.domain, b.path, zD, O.g.P))
            }
            return d
        }
        , zD = ["GA1"]
        , BD = function (a, b) {
            var c = a.h[O.g.ab];
            if (U(a.m, O.g.xb) && U(a.m, O.g.Ob) || b && c === b)
                return c;
            if (c) {
                c = "" + c;
                if (!AD(c, a))
    ...
    var ED = function (a, b, c) {
        ...
        if (!d)
            return b;
        var e, f = Qa(null != (e = U(c.m, O.g.bd)) ? e : 30);
        ...
        g.Ec = d.Ec + 1;
        var h;
        return null != (h = DD(g.sessionId, g.Ec, g.md, g.Ee, g.Dh, g.Cc, g.ue)) ? h : b
    }
        , HD = function (a, b) {
            var c = b.metadata.cookie_options
                , d = FD(b, c)
                , e = Zm(a, GD[0], c.domain, c.path)
                , f = {
                    Eb: O.g.P,
                    domain: c.domain,
                    path: c.path,
                    expires: c.Cb ? new Date(Va() + 1E3 * c.Cb) : void 0,
                    flags: c.flags
                };
            Rm(d, void 0, f);
            return 1 !== Rm(d, e, f)
        ...
        , ID = function (a) {
            var b = a.metadata.cookie_options
                , c = FD(a, b)
                , d = Ym(c, b.domain, b.path, GD, O.g.P);
            if (!d)
                return d;
            var e = zm(c, void 0, void 0, O.g.P);
            if (d && 1 < e.length) {
                N(114);
        ...
        , JD = function (a) {
            return DD(a.h[O.g.ib], a.h[O.g.Wd], a.h[O.g.Vd], Math.floor(a.metadata.event_start_timestamp_ms / 1E3), a.metadata.join_timer_sec || 0, !!a.metadata[O.g.ef], a.h[O.g.Wc])
        };
    var KD = function (a) {
        var b = U(a.m, O.g.Aa)
            , c = a.m.C[O.g.Aa];
        ...
        , OD = function (a) {
            var b = KD(a) || {}
                ...
                , e = FD(a, c)
                , f = {};
            Lo(b[O.g.qc], !!b[O.g.U]) && (f = MD(a, d, e),
                f.clientId && f.Xf && (ND = !0));
            b[O.g.U] && Io(function () {
                var g = {}
                    , h = yD(a);
                h && (g[d] = h);
                var l = ID(a);
                l && (g[e] = l);
                var n = zm("FPLC", void 0, void 0, O.g.P);
                n.length && (g._fplc = n[0]);
                return g
            }, b[O.g.U], b[O.g.Pb], !!b[O.g.yb]);
            return f
        }
        , QD = function (a) {
            if (!U(a.m, O.g.jb))
    ...
    var TD = function (a, b) {
        ...
        , WD = function (a) {
            ...
            var b = Ss(Us(a.m), "/g/collect");
            if (b)
                return b;
            var c = Xp(a, O.g.hb, U(a.m, O.g.hb));
            c = c || kD(a);
            var d = U(a.m, O.g.tb);
            return c && !wi() && !1 !== d && XB() && wk(O.g.H) && wk(O.g.P) ? UD() : VD()
        }
        , XD = !1;
    XD = !0;
    var YD = {};
    ...
    aE[O.g.Rc] = "ck";
    var bE = {}
        , cE = Object.freeze((bE[O.g.na] = 1,
            bE))
        , VD = function () {
            var a = "api";
            XD && yi() && (a = yi());
            return "https://" + a + ".angelytics.ai/api/g-event"
        }
        , UD = function () {
            var a;
            XD && "" !== yi() && (a = yi());
        ...
        , dE = function (a, b, c) {
                ...
                if (void 0 !== t && !xh.hasOwnProperty(r)) {
                    ...
                    if (!u && r !== O.g.ef) {
                        ...
                        if (YD[r])
                            ...
                            var x;
                            aE[r] ? x = !0 : r !== O.g.Pc ? x = !1 : ("object" !== typeof t && p(r, t),
                                x = !0);
                            x || p(r, t)
                        }
                    }
            ...
            (function (r) {
                lD(a) && "object" === typeof r && m(r || {}, function (t, u) {
    ...
    var kE = function (a, b, c, d) {
        ...
        , lE = function (a, b) {
            ...
            if (d || e) {
                ...
                d && (jE("https://stats.g.doubleclick.net/g/collect", "v=2&" + p.join("&")),
    ...
    mE.prototype.add = function (a) {
        a.metadata.euid_mode_enabled && !pD ? this.T(a) : this.C(a)
    }
        ;
    mE.prototype.flush = function () {
        if (this.h.events.length) {
            var a = Lf(this.h, this.D++);
            kE(this.h.h, a.Nh, a.body, this.h.B);
            this.h = new If;
    ...
    var sE = window
        ...
        , uE = function (a) {
            ...
            if (b && b.ioo && b.ioo() || tE.documentElement.hasAttribute("data-google-analytics-opt-out") || a && !0 === sE["ga-disable-" + a])
                return !0;
            try {
                var c = sE.external;
            ...
            for (var d = tm("AMP_TOKEN", String(tE.cookie), !0), e = 0; e < d.length; e++)
                if ("$OPT_OUT" == d[e])
                    return !0;
    ...
    var wE = function (a) {
        ...
        , AE = (zE[O.g.Lc] = 1,
            ...
            zE[O.g.Rc] = 1,
            zE)
        , vE = /^(_|ga_|google_|gtag\.|firebase_).*$/
        , BE = function (a) {
            this.qb = a;
            this.zd = new mE;
            this.h = void 0;
    ...
    ba.Xl = function (a, b, c) {
        ...
        if (e)
            if (c.eventMetadata.is_external_event && "_" === a.charAt(0))
                ...
                a !== O.g.ka && a !== O.g.Ia && wE(a) && N(58);
                CE(c.h);
                var f = new Wp(e, a, c);
                f.metadata.event_start_timestamp_ms = b;
                var g = [O.g.P];
                (Xp(f, O.g.hb, U(f.m, O.g.hb)) || lD(f)) && g.push(O.g.H);
                T(86) && lD(f) && g.push(O.g.Jb);
                var h = function () {
                    Sk(function () {
                        d.Yl(f)
                    }, g)
    ...
    ba.Yl = function (a) {
        ...
        try {
            if (uE(a.target.ba))
                ...
                if (b && Ja(b.destinations))
                    for (var e = 0; e < b.destinations.length; e++)
                        if (uE(b.destinations[e])) {
                            N(125);
                            a.isAborted = !0;
                            break
                        }
            }
            if (0 <= go.Uk.replace(/\s+/g, "").split(",").indexOf(a.eventName))
                a.isAborted = !0;
            else {
                var f = nD(a);
            ...
            "http:" != g && "https:" != g && (N(29),
                a.isAborted = !0);
            hc && "preview" == hc.loadPurpose && (N(30),
                a.isAborted = !0);
            T(54) && (a.isAborted = !0);
            vq(a);
            var h = Lh.grl;
            ...
            var l = {
                prefix: String(U(a.m, O.g.Ka, "")),
                path: String(U(a.m, O.g.Tc, "/")),
                flags: String(U(a.m, O.g.Na, "")),
                domain: String(U(a.m, O.g.Ma, "auto")),
                Cb: Number(U(a.m, O.g.Fa, 63072E3))
            };
            a.metadata.cookie_options = l;
            DE(a);
            this.yk(a);
            this.D.ym(a);
            a.metadata.is_merchant_center ? a.metadata.euid_mode_enabled = !1 : U(a.m, O.g.nf) ? a.metadata.euid_mode_enabled = !1 : Xp(a, "ccd_add_1p_data", !1) ? a.metadata.euid_mode_enabled = !0 : a.metadata.euid_mode_enabled = T(10) ? !1 : Vj(Tj(a.m));
            if (a.metadata.euid_mode_enabled) {
                var n = Tj(a.m);
                if (Vj(n)) {
                    var p = U(a.m, O.g.na);
                    if (Xp(a, "ccd_add_1p_data", !1))
            ...
            var r = this.Jj, t;
            U(a.m, O.g.jb) && (wk(O.g.P) || U(a.m, O.g.ab) || (a.h[O.g.ej] = !0));
            var u;
            var v;
            v = void 0 === v ? 3 : v;
            ...
            if (a.eventName !== O.g.ka)
                ...
                U(a.m, O.g.jb) && wp(["aw", "dc"]);
                var A = OD(a)
                    , B = QD(a);
                t = T(61) && Object.keys(A).length ? A : B
            }
            r.call(this, t);
            var C = a.eventName === O.g.ka;
            C && (this.K = !0);
            a.eventName == O.g.ka && (U(a.m, O.g.Pa, !0) ? (a.m.h[O.g.X] && (a.m.B[O.g.X] = a.m.h[O.g.X],
                a.m.h[O.g.X] = void 0,
                a.h[O.g.X] = void 0),
                a.eventName = O.g.ic) : a.isAborted = !0);
            C && !a.isAborted && 0 < this.Wg++ && tD(17);
            var F = db(Rl(a.m, O.g.X, 1), ".");
            F && (a.h[O.g.wb] = F);
            var J = db(Rl(a.m, O.g.X, 2), ".");
            J && (a.h[O.g.vb] = J);
            var K = this.C
                , P = this.D
                , Q = !this.ie
            ...
            if (U(a.m, O.g.xb) && U(a.m, O.g.Ob))
                ...
                if (!ea) {
                    var R = wk(O.g.P)
                        , pa = uD();
                    ea = !pa.from_cookie || R ? pa.vid : void 0;
                    W = 6
                }
                ea ? ea = "" + ea : (ea = Vm(),
                    W = 7,
            ...
            var ka = Math.floor(a.metadata.event_start_timestamp_ms / 1E3)
                , ja = void 0;
            a.metadata.is_new_to_site || (ja = ID(a) || K);
            var Ha = Qa(U(a.m, O.g.bd, 30));
            Ha = Math.min(475, Ha);
            Ha = Math.max(5, Ha);
            var fb = Qa(U(a.m, O.g.rf, 1E4))
                , ma = CD(ja);
            a.metadata.is_first_visit = !1;
            a.metadata.is_session_start = !1;
            a.metadata.join_timer_sec = 0;
            ma && ma.Dh && (a.metadata.join_timer_sec = Math.max(0, ma.Dh - Math.max(0, ka - ma.Ee)));
            var Na = !1;
            ...
            if (Na)
                a.metadata.is_session_start = !0,
                    P.rl(a);
            else if (P.jl() > fb || a.eventName == O.g.ic)
                ma.md = !0;
            a.metadata.euid_mode_enabled ? U(a.m, O.g.Ba) ? ma.Cc = !0 : (ma.Cc && (ma.ue = void 0),
                ma.Cc = !1) : ma.Cc = !1;
            var qb = ma.ue;
            if (a.metadata.euid_mode_enabled) {
                var ic = U(a.m, O.g.Wc)
                ...
                if (void 0 === yu || ff <= yu)
                    a.h[O.g.Wc] = ic.toString(),
                        a.metadata.enhanced_client_id_source = ff
            }
            Q ? (a.copyToHitData(O.g.ib, ma.sessionId),
                a.copyToHitData(O.g.Wd, ma.Ec),
                a.copyToHitData(O.g.Vd, ma.md ? 1 : 0)) : (a.h[O.g.ib] = ma.sessionId,
                    a.h[O.g.Wd] = ma.Ec,
                    a.h[O.g.Vd] = ma.md ? 1 : 0);
            a.metadata[O.g.ef] = ma.Cc ? 1 : 0;
            EE(a);
            if (!U(a.m, O.g.Ob) || !U(a.m, O.g.xb)) {
                var zu = ""
                    , zg = G.location;
                if (zg) {
                    var Di = zg.pathname || "";
                    "/" != Di.charAt(0) && (Di = "/" + Di);
                    zu = zg.protocol + "//" + zg.hostname + Di + zg.search
                }
                a.copyToHitData(O.g.fa, zu);
                var AG = a.copyToHitData, BG = O.g.Ga, Ei;
                a: {
                    var Au = zm("_opt_expid", void 0, void 0, O.g.P)[0];
                    if (Au) {
                    ...
                    if (void 0 !== Lh.ga4_referrer_override)
                        Ei = Lh.ga4_referrer_override;
                    else {
                        var Cu = ki("gtm.gtagReferrer." + a.target.ba);
                        Ei = Cu ? "" + Cu : G.referrer
                    }
                }
                AG.call(a, BG, Ei || void 0);
                a.copyToHitData(O.g.zb, G.title);
                a.copyToHitData(O.g.za, (hc.language || "").toLowerCase());
                var Du = Li();
                a.copyToHitData(O.g.Ab, Du.width + "x" + Du.height);
                T(39) && a.copyToHitData(O.g.Qb)
            }
            a.metadata.create_dc_join = !1;
            a.metadata.create_google_join = !1;
            if (!(T(66) && lD(a) || a.metadata.is_merchant_center || !1 === U(a.m, O.g.tb)) && XB() && wk(O.g.H)) {
                var Fi = Xp(a, O.g.hb, U(a.m, O.g.hb));
                Fi = Fi || kD(a);
                (a.metadata.is_session_start || U(a.m, O.g.hf)) && (a.metadata.create_dc_join = !!Fi);
                var Eu;
                Eu = a.metadata.join_timer_sec;
                Fi && 0 === (Eu || 0) && (a.metadata.join_timer_sec = 60,
                    a.metadata.create_google_join = !0)
            }
            FE(a);
            Bh.hasOwnProperty(a.eventName) && (a.metadata.is_ecommerce = !0,
                a.copyToHitData(O.g.W),
                a.copyToHitData(O.g.wa));
            a.copyToHitData(O.g.uf);
            for (var Fu = U(a.m, O.g.jf) || [], Em = 0; Em < Fu.length; Em++) {
                var Gu = Fu[Em];
                if (Gu.rule_result) {
            ...
            if (!a.metadata.is_merchant_center && Us(a.m)) {
                var Hu = KD(a) || {}
                    , DG = (Lo(Hu[O.g.qc], !!Hu[O.g.U]) ? Co(!0)._fplc : void 0) || (0 < zm("FPLC", void 0, void 0, O.g.P).length ? void 0 : "0");
                a.h._fplc = DG
            }
            if (void 0 !== U(a.m, O.g.Sd))
                a.copyToHitData(O.g.Sd);
            else {
                var Iu = U(a.m, O.g.Ud), Fm, Gi;
                a: {
                    if (ND) {
                        var Gm = KD(a) || {};
                        if (Gm && Gm[O.g.U])
                            for (var Ju = $i(bj(a.h[O.g.Ga]), "host", !0), Hi = Gm[O.g.U], Ag = 0; Ag < Hi.length; Ag++)
                                if (Hi[Ag] instanceof RegExp) {
                                    if (Hi[Ag].test(Ju)) {
                                        Gi = !0;
                                        break a
                                    }
                                } else if (0 <= Ju.indexOf(Hi[Ag])) {
                                    Gi = !0;
                                    break a
                                }
                    }
                ...
                if (!(Fm = Gi)) {
                    ...
                    if (Ii = Iu)
                        a: {
                            for (var Ku = Iu.include_conditions || [], EG = $i(bj(a.h[O.g.Ga]), "host", !0), Hm = 0; Hm < Ku.length; Hm++)
                                if (Ku[Hm].test(EG)) {
                                    Ii = !0;
                                    break a
                                }
            ...
            lD(a) && (oD(a, "uc", ui()),
                zk() && oD(a, "rnd", $m()));
            if (T(29) && lD(a)) {
                Xp(a, O.g.hb, !1) && oD(a, "gse", 1);
                !1 === U(a.m, O.g.tb) && oD(a, "ngs", 1);
                wi() && oD(a, "ga_rd", 1);
                XB() || oD(a, "ngst", 1);
                var Lu = Ai();
                Lu && oD(a, "etld", Lu)
            ...
            lD(a) && zk() && (Ak() && oD(a, "gcd", qm(a.m)),
                U(a.m, O.g.la) && oD(a, "adr", 1));
            if (lD(a)) {
                var Nu = Qq();
            ...
            a: if (T(7))
                if (!bo(z))
                    ...
                    if (Qu) {
                        if (T(26)) {
                            if (U(a.m, O.g.ad) && !lD(a))
                                break a
                        } else if (U(a.m, O.g.ad))
                            break a;
                        io(Qu, a)
                    } else
                        N(86)
                }
            T(27) && U(a.m, O.g.xb) && tD(12);
            if (T(38)) {
                var Im = yq(xq());
                Im || GE || (GE = !0,
                    rn(''),
                    Im = yq(xq()));
                Im && (a.h[O.g.Mb] = "1")
            }
            if (a.eventName == O.g.Ia) {
                var Su = U(a.m, O.g.Oa)
                    , FG = U(a.m, O.g.fb)
                    , Tu = void 0;
                Tu = a.h[Su];
            ...
            $p(a);
            rE(a);
            a.metadata.em_event && tD(14);
            !this.K && a.metadata.em_event && tD(18);
            var Jm = a.metadata.event_usage;
            if (Ja(Jm))
                for (var Km = 0; Km < Jm.length; Km++)
                    tD(Jm[Km]);
            var Uu = zb("GA4_EVENT");
            Uu && (a.h._eu = Uu);
            ...
            var GG = this.Jj, Vu, HG = this.h, Lm;
            a: {
                var Mm = JD(a);
                if (Mm) {
                    if (HD(Mm, a)) {
            ...
            if (lD(a)) {
                ...
                if ("page_view" === a.eventName || JG)
                    yE(this, a, O.g.H),
                        T(86) && yE(this, a, O.g.Jb)
            }
            this.D.Sh();
            this.je = HE(a, this.je);
            a.copyToHitData(O.g.zg);
            U(a.m, O.g.ad) && (a.h[O.g.ad] = !0,
                T(35) && lD(a) || xE(a, O.g.Ab));
            if (a.isAborted) {
                a.m.onFailure();
                yb();
                return
    ...
    ba.vm = function (a) {
        ...
        ;
    ba.yk = function (a) {
        a.eventName !== O.g.Ia && this.D.xk(a)
    }
        ;
    var DE = function (a) {
        function b(c, d) {
    ...
    ; var IE = function (a) {
        if (T(77) && "prerendering" in G ? G.prerendering : "prerender" === G.visibilityState)
            return !1;
        a();
        return !0
    }
                ...
                var b = !1
                    , c = function () {
                        !b && IE(a) && (b = !0,
                            ...
                            T(77) && uc(G, "prerenderingchange", c),
                            N(55))
                    };
                tc(G, "visibilitychange", c);
                T(77) && tc(G, "prerenderingchange", c);
                N(54)
            }
        };
    var LE = function (a, b) {
    ...
    function ME(a, b, c) {
        ...
        d.bm(function () {
            pD = !0;
            yv.flush();
            1E3 <= d.Lf() && hc.sendBeacon && Av(O.g.Ad, {}, a.id, f);
            b.flush();
            d.Kj(function () {
                pD = !1;
                d.Kj()
    ...
    function CF(a, b, c) {
        L(E(this), ["targetId:!string", "name:!string", "value:!*"], arguments);
        for (var d = b.split("."), e = Dv(a), f = 0; f < d.length - 1; f++) {
            if (void 0 === e[d[f]])
                e[d[f]] = {};
            else if (!Uc(e[d[f]]))
    ...
    FF.removeItem = function (a) {
        ...
        if (!b)
            throw Error("invalid program state");
        var c = b.jd();
        if (!GF[c] || !GF[c].hasOwnProperty("gtm." + a))
            return;
        delete GF[c]["gtm." + a];
    }
        ;
    ...
    Z.o.gct = ["google"],
        function () {
            ...
            (function (d) {
                ...
                0 < f && (e[O.g.bd] = f);
                e[O.g.Ld] = d.vtp_eventSettings;
                e[O.g.ng] = d.vtp_dynamicEventSettings;
                e[O.g.hb] = 1 === d.vtp_googleSignals;
                e[O.g.Ag] = d.vtp_foreignTld;
        ...
        if (Xh)
            ...
            var f = function (u) {
                ...
                x || (x = [],
                    ...
                    pc("https://" + Kh.Ye + "/debug/bootstrap?id=" + rf.ctid + "&src=" + w + "&cond=" + u + "&gtm=" + cn()));
                var y = {
